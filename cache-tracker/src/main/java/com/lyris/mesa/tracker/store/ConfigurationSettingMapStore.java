 ...
 *
 */
public class ConfigurationSettingMapStore implements MapStore<String, Object> {

	/** Reference to logger */
	private final Logger logger = Logger
			.getLogger(ConfigurationSettingMapStore.class);

	private static final String MAP_NAME = AbstractTracker.CONFIGURATION_MAP;

	public ConfigurationSettingMapStore() {
		logger.info("ConfigurationSettingMapStore instance created ....");
	}
