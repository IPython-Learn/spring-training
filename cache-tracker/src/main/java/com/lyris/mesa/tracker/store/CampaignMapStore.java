 ...
 *
 */
public class CampaignMapStore implements MapStore<String, Object> {

	/** Reference to logger */
	private final Logger logger = Logger.getLogger(CampaignMapStore.class);

	private static final String MAP_NAME = AbstractTracker.CAMPAIGN_MAP;

	public CampaignMapStore() {
		logger.info("CampaignMapStore instance created ... ");
	}
