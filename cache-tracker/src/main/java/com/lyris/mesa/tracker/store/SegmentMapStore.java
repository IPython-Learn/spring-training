 ...
 *
 */
public class SegmentMapStore implements MapStore<String, Object> {

	/** Reference to logger */
	private final Logger logger = Logger.getLogger(SegmentMapStore.class);

	private static final String MAP_NAME = AbstractTracker.SEGMENT_MAP;

	public SegmentMapStore() {
		logger.info("SegmentMapStore  created ...");
	}
