 ...
 *
 */
public class MessageContextMapStore implements MapStore<String, Object> {

	/** Reference to logger */
	private final Logger logger = Logger
			.getLogger(MessageContextMapStore.class);

	private static final String MAP_NAME = AbstractTracker.MEG_CONTEXT_MAP;

	public MessageContextMapStore() {
		logger.info("MessageContextMapStore  created ...");
	}
