 ...
 *
 */
public class ContactSetMapStore implements MapStore<String, Object> {

	/** Reference to logger */
	private final Logger logger = Logger.getLogger(ContactSetMapStore.class);

	private static final String MAP_NAME = AbstractTracker.CONTACTSET_MAP;

	public ContactSetMapStore() {
		logger.info("ContactSetMapStore instance created ...");
	}
