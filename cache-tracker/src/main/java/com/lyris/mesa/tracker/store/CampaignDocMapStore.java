 ...
 *
 */
public class CampaignDocMapStore implements MapStore<String, Object> {

	/** Reference to logger */
	private final Logger logger = Logger.getLogger(CampaignDocMapStore.class);

	private static final String MAP_NAME = AbstractTracker.CAMPAIGNDOC_MAP;

	public CampaignDocMapStore() {
		logger.info("  CampaignDocMapStore instance  created ....");
	}
