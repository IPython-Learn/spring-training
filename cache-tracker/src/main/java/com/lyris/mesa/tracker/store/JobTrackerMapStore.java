 ...
 *
 */
public class JobTrackerMapStore implements MapStore<String, Object> {

	/** Reference to logger */
	private final Logger logger = Logger.getLogger(JobTrackerMapStore.class);

	private static final String MAP_NAME = AbstractTracker.JOB_TRACKER_MAP;

	public JobTrackerMapStore() {
		logger.info("JobTrackerMapStore instance  created ...");
	}
