 ...
 * <li><b>registerDestructionCallback : </b> callback method and gets invoked
 * when the object in this scope is destroyed</li>
 * <li><b>getConversationId :he exact meaning of the conversation ID depends on
 * the underlying storage mechanism. In the case of session-scoped objects, the
 * conversation ID would typically be equal to (or derived from) the session ID;
 * </b></li>
 * </ul>
 * 
 * </p>
...
public class ThreadScope implements Scope {
	...
	public Object get(String name, ObjectFactory<?> objectFactory) {
		...
		Map<Object,Object> scope = (Map<Object,Object>) threadScope.get();
